...
Hi, I'm a full stack developer with a diverse backround in computing technologies,
working primarily in the broadband and casual games industries.

My technical experience is in enterprise networking, Linux system administration,
build & release automation, and devops. I have also done some light database,
software, and web development work.

I'm looking to expand into roles related to software development for
technologies with a focus on human-centered outcomes, particularly linguistics
and language learning.

## About me

* Experienced Linux sysadmin and Build Automation Engineer with professional coding experience
* In my spare time I like to work on interactive art, hobby electronics, wood working and metal fabrication
* Pronouns: he/him
...
* Front-end Coding using HTML, CSS, & React
* Linux server management
* Enterprise Networking
* Cloud Computing (CGP/Azure)
...
This project builds a geographically redundant, load-balanced pair of VM
Linux-based web hosts running nginx, using Terraform and Google Cloud Project.
This is a quick way to scaffold up a web service for lower environments and easy
A/B testing by manipulating active hosts in the load balancer. This can also be
customized to use your other docker images or add additional cloud components.

* [Codebase](https://github.com/chris-hunter206/terraform-gcp-nginx_lb_pair)

### Console Blackjack

A simplified blackjack game, playable from the unix command-line terminal.
Written in javascript.

* [Codebase](https://github.com/chris-hunter206/javascript-blackjack)

## Education

* Associate of Science in Computing and Software Development from Lake Washington Institute of Technology
* Enrolled as an Informatics major/Linguistics minor at University of Washington
